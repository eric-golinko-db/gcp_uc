...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``gcp_uc/resources/model-workflow-resource.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in gcp_uc/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in gcp_uc/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text("model_name", "dev.gcp_uc.gcp_uc-model", "Full (Three-Level) Model Name")
