...
Opening a pull request will trigger a[workflow](../.github/workflows/gcp_uc-run-tests.yml) 
...
Links:
* [Staging model in UC](https://416411475796958.8.gcp.databricks.com/explore/data/models/staging/gcp_uc/gcp_uc-model)
* [Prod model in UC](https://416411475796958.8.gcp.databricks.com/explore/data/models/prod/gcp_uc/gcp_uc-model)
. 
